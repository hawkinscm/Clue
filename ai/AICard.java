...
public enum AICard {
  ...
  private static List<AICard> rooms = new ArrayList<AICard>();
  private static List<AICard> suspects = new ArrayList<AICard>();
  private static List<AICard> weapons = new ArrayList<AICard>();
  static {
