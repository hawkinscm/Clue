...
public class BoardDesignerPanel extends JPanel {
	...
	private final static int DEFAULT_BOARD_HEIGHT = 25;
	private final static int DEFAULT_BOARD_WIDTH = 25;
	...
	public void previewBoard() {
		...
		previewBoardDialog.setSize(previewWidth, previewHeight);
	...
	public void loadBoard(Board boardToLoad, List<Room> newRooms, List<Suspect> newSuspects) {
		...
		if (!errorMessages.isEmpty()) {
			...
			message.append("Some changes from the loaded Clue Board are invalid and were not applied:");
			for (String errorMessage : errorMessages)
				message.append("<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;").append(errorMessage);
			message.append("</html>");
			Messenger.warn(message.toString(), "Invalid Clue Board Values");
		}
