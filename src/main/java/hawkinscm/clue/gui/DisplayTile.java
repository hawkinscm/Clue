...
public class DisplayTile extends JButton {
	...
	public void addSuspect(Suspect suspect, Direction direction) {
		...
		StringBuilder suspectNames = new StringBuilder("<html>");
		for (Suspect tileSuspect : suspects)
			suspectNames.append(tileSuspect.getName()).append("<br>");
		suspectNames.append("</html>");
		setToolTipText(suspectNames.toString());
	...
	public void rotateSuspectDirection() {
        ...
        g.rotate(Math.toRadians(90), width/2.0, height/2.0);
