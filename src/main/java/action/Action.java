...
/**
 * Abstract class representing an main.java.action that can be communicated via text across a network.
...
public abstract class Action<T> {
	...
	/**
	 * Sets the message for this main.java.action.
	 * @param message main.java.action message to set
	 */
	...
	/**
	 * Returns the main.java.action message without the main.java.action class specifier heading.
	 * @return the main.java.action message without the main.java.action class specifier heading
	 */
	...
	/**
	 * Returns this main.java.action as a string message.
	 * @return this main.java.action as a string message
	 */
	...
	/**
	 * Performs this main.java.action using the given object.
	 * @param obj object needed to performing the main.java.action.
	...
	/**
	 * Parses the given main.java.action message then creates and returns an Action ready to be performed.
	 * @param actionMessage main.java.action message to parse
