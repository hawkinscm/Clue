 ...
 * @see jdd.graph.BreadthFirstSearch
 * @see jdd.graph.DepthFirstSearch
 * @see jdd.graph.TopologicalSort
 * @see jdd.graph.SimpleAlgorithms
 */
...
public class GraphOperation {
	...
	/**
	 * <tt>Haj�s's construction</tt>: Let G1 and G2 be already disjoint graphs with edges x1y1<br>
	 * and x2y2. Remove x1y1 and x2y2, identify x1 and 2 and join y1 and y2 by a new edge.<br>
	 *<br>
	 * This is interesting due to the Haj�s Theorem from 1961:<br><i>
	 * A graph has chromatic number at least k iff it contains a Haj�s-k-constructible subgraph.<br>
	 * Every k-ciritical graph is Haj�s-k-constructible
	 * </i><br>
	 * <br><br>
