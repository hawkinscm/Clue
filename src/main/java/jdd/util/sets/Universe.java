...
public interface Universe {
	 ...
	 * <p>NOTE: you must call this function in order to free all used memory.
	 * a call to free() also frees all Set and SetEnumeration objects (making then invalid!)

	 * @see jdd.util.sets.Set#free
	 */
	void free();
