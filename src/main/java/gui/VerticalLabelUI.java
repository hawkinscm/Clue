...
/**
 * Label for display text vertically, on the y-axis.
 */
public class VerticalLabelUI extends BasicLabelUI {
	private boolean flowDown = false;
	...
	/**
	 * Creates a new empty vertical label.
	 */
	public VerticalLabelUI() {}

	/**
	 * Creates a new empty vertical label with text flowing in the specified direction.
	 * @param flowDown if true, text will read from top to bottom; otherwise text will read from bottom to top
	 */
	public VerticalLabelUI(boolean flowDown) {
