...
public class PDDL21parser implements PDDL21parserConstants {
  ...
  public static UngroundProblem getUngroundProblem() {
    return UP;
  }
  ...
  private static boolean parseDomainFile(File pFile) {
    ...
    if (req) {
      JavaFF.parsingOutput.println("Parsed Domain file " + pFile + " successfully");
    }
    else {
      JavaFF.parsingOutput.println("Parsing of Domain file " + pFile + " failed");
    }
    return req;
  }
  ...
  private static boolean parseProblemFile(File pFile) {
    ...
    if (probsuc) {
      JavaFF.parsingOutput.println("Parsed Problem file " + pFile + " successfully");
    }
    else {
      JavaFF.parsingOutput.println("Parsing Problem file " + pFile + " failed");
    }
    return probsuc;
  }
  ...
  final public boolean parseRequireDef() throws ParseException {
    ...
    while (true) {
      ...
      if (jj_2_8(20)) {
        ...
        JavaFF.parsingOutput.println("cannnot parse " + t.toString());
        {
          if (true) {
            return false;
          }
...
// ***************************************************
  ...
  final public OperatorName parseOperatorName() throws ParseException {
    ...
    {
      if (true) {
        return new OperatorName(t.toString());
      }
    }
    throw new Error("Missing return statement in function");
  }
...
// **********************************
  ...
  final public int parseOptimization() throws ParseException {
    ...
    if (t1.toString().equals("minimize")) {
      if (true) {
        return Metric.MINIMIZE;
      }
    }
    else if (t1.toString().equals("maximize")) {
      if (true) {
