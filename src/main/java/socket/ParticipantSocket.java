...
/**
 * A host-connected main.java.socket that is used to communicate back and forth between the host and the participant.
 */
public class ParticipantSocket extends Socket {
	 ...
	 * @throws IOException on any main.java.socket, reading, or writing error
	 */
