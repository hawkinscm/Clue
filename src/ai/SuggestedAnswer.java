...
/**
 * Represents a Card answer given by another player to answer a suggestion.  The Card used to answer will be one of three. 
 */
public class SuggestedAnswer {
	 ...
	 * @param player player who answered
	 ...
	 * @param owner the owner of the given card
	...
	public void presentNewFact(Player player, Card card, boolean hasCard) {
		...
		else if (hasCard && player == answerer){
			if (room != null && card.matches(room)) {
				suspect = null;
				weapon = null;
			}
