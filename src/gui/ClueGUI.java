...
public abstract class ClueGUI extends JFrame implements Observer {
	...
	public ClueGUI() {
		...
		playerCardCountMap = new LinkedHashMap<String, Integer>();	
	...
	private void createMenuBar() {
		...
		createDesignMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new GameDesignerDisplay(ClueGUI.this, null).setVisible(true);
			}
		});
	...
	public void loadGame(final ClueGameData gameData) {
		...
		cardsMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				displayControlledPlayerCards();
			}
		});
		infoMenu.add(cardsMenuItem);
		
		JMenuItem cardCountMenuItem = new JMenuItem("All Player Card Counts");
		cardCountMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String message = "<html>";
				for (String playerName : playerCardCountMap.keySet())
					message += playerName + ": " + playerCardCountMap.get(playerName) + "<br>";
				message += "</html>";
				Messenger.display(message, "All Player Card Counts");
			}
		});
		infoMenu.add(cardCountMenuItem);
		
		JMenuItem storyMenuItem = new JMenuItem("Story");
		storyMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Messenger.display(story, "Game Story", ClueGUI.this);
			}
		});
	 ...
	 * @param suggestedSuspected suggested suspect
	 ...
	 * @param accusedSuspected accused suspect
