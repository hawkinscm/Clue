...
import gui.gamecreator.BoardDesignerPanel;
...
public class ResizeBoardChange extends Change {
	...
	public String applyChange() {
		LinkedList<DisplayTile> hiddenTiles = new LinkedList<DisplayTile>();
		...
		HashMap<Room, RemoveRoomChange> removeRoomChanges = new HashMap<Room, RemoveRoomChange>();
