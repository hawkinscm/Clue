...
public class RemoveRoomChange extends Change {
	...
	public RemoveRoomChange(Board board, Room room) {
		...
		removedTileDoors = new HashMap<DisplayTile, ArrayList<DisplayTile.Direction>>();
	}
	...
	public void addChangedTile(DisplayTile tile) {
		...
		tile.removeRoom();
		removedTileDoors.put(tile, new ArrayList<DisplayTile.Direction>());
		...
		LinkedList<LinkedList<DisplayTile>> roomGroups = new LinkedList<LinkedList<DisplayTile>>();
		LinkedList<DisplayTile> biggestGroup = null;
		LinkedList<DisplayTile> checkedRoomTiles = new LinkedList<DisplayTile>();
		for (DisplayTile roomTile : roomTiles) {
			if (checkedRoomTiles.contains(roomTile))
				continue;
			
			LinkedList<DisplayTile> roomGroup = new LinkedList<DisplayTile>();			
