...
public class CardDesignerPanel extends JPanel {
	...
	private JComboBox numRoomsComboBox;
	...
	private JPanel createNumRoomsPanel() {
		...
		numRoomsComboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				setNumRooms((Integer) ((JComboBox) e.getSource()).getSelectedItem());
			}
		});
	...
	private JPanel createRoomDetailsPanel() {
		...
		displayRoomPicturesOnBoardCheckBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
	...
	private JPanel createNumSuspectsPanel() {
		...
		numSuspectsComboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				setNumSuspects((Integer) ((JComboBox) e.getSource()).getSelectedItem());
			}
		});
	...
	private JPanel createNumWeaponsPanel() {
		...
		numWeaponsComboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				setNumWeapons((Integer) ((JComboBox) e.getSource()).getSelectedItem());
			}
		});
